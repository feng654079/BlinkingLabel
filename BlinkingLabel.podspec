...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/feng654079/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'feng654079' => '417600039@qq.com' }
  s.source           = { :git => 'https://github.com/feng654079/BlinkingLabel.git', :tag => s.version.to_s }
